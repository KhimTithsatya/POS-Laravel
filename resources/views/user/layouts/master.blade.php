        ...
        <div class="container-fluid fixed-top">
            <div class="container topbar d-none d-lg-block" style="background-color: #191970">
                ...
                <div class="top-info ps-2">
                    ...
                    <a href="#" class="text-white">Phnom Penh</a></small
                    >
                    <small class="me-3"
                    ><i class="fas fa-envelope me-2 text-secondary"></i
                    ><a href="#" class="text-white">kdcoffee@gmail.com</a></small
                    >
                </div>
            ...
            <div class="container px-0">
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                           <a href={{route('userDashboard')}} class="navbar-brand"
                                ><h1 class="text-dark display-6">KD COFFEE</h1></a
        ...
        <div class="container py-5">
            <div class="pb-4 mb-4" style="border-bottom: 1px solid rgba(226, 175, 24, 0.5) ;">
                <div class="row g-4">
                    <div class="col-lg-3">
                        <a href="#">
                            <h1 class="text-white mb-0">KD COFFEE</h1>
                            <p class="text-secondary mb-0">since 2025</p>
                        </a>
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-3">
                        <div class="d-flex justify-content-end pt-3">
                            <a class="btn btn-outline-secondary btn-md-square rounded-circle" href="https://t.me/Satya0307"><i class="fab fa-facebook"></i></a>
                            <a class="btn btn-outline-secondary btn-md-square rounded-circle" href="https://t.me/Satya0307"><i class="fab fa-telegram"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    <div class="footer-item">
                        ...
                        <p class="mb-4">We serve all the customer </p>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-item">
                        ...
                        <p>Address: 317 St, Phnom Penh</p>
                        <p>Email: Kdcoffee@gmail.com</p>
                        <p>Phone: 016342853</p>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 my-auto text-center text-md-end text-white">
                    Designed By Satya <a class="border-bottom" href="">
                </div>
            </div>
        </div>
    </div>
