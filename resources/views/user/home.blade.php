            ...
            >
              <div class="carousel-inner" role="listbox">
                <div class="carousel-item active rounded">
                  <img
                    src="{{ asset('customer/img/banner3.0.jpg') }}"
                ...
                <div class="carousel-item rounded">
                  <img
                    src="{{ asset('customer/img/banner4.0.jpg') }}"
                    class="img-fluid w-100 h-100 rounded"
                    alt="Second slide"
                  />
                  <a href="{{route('shopList')}}" class="btn-warning px-4 py-2 text-white rounded"
            ...
            <div class="tab-class text-center text-white">
                <div class="row g-4  bg-gradient-succes">
                    <div class="col-lg-4 text-start">
                        <h1 class="text-white">Our Drink</h1>
                    ...
                    <div class="col-lg-4 text-end">
                        <ul class="nav nav-pills d-inline-flex text-center mb-5">
                            <li class="nav-item">
                                <img src="{{ asset('customer/img/best-coffee1.jpg') }}"
                    ...
                    <div class="col-lg-4 text-end">
                        <ul class="nav nav-pills d-inline-flex text-center mb-5">
                            <li class="nav-item">
                            <img src="{{ asset('customer/img/best-strawberry.jpg') }}"
                                    class="img-fluid bg-secondary rounded"
                                    style="width: 100%; height: 400px; object-fit: cover;">
                            </li>
                        </ul>
